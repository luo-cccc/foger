...
- 长篇生产提示词统一围绕“新颖设定、熟悉爽点、高压关系、因果反转、情绪钩子”协作；反转必须有前置证据并改变后续行动，喘息章可以专注承接后果。
...
inkos book backup 吞天魔帝     # 备份整本书
inkos book backup 吞天魔帝 --list  # 列出现有备份
inkos book restore 吞天魔帝 <backup-id>  # 恢复并自动保存恢复前状态
```
