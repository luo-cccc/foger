import type { ActionPayload, ActionSource, RequestedIntent, SessionKind } from "@actalk/inkos-core";
...
export interface ToolExecution {
  ...
  logs?: string[];
  llmCalls?: ReadonlyArray<ToolLLMCall>;
  startedAt: number;
  completedAt?: number;
}
...
export interface CreateState {
  ...
  artifactEpisode: number | null;      // episode number, e.g. 1
...
export interface CreateActions {
  ...
  openEpisodeArtifact: (episodeNum: number) => void;
  closeArtifact: () => void;
