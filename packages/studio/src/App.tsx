...
const EpisodeReader = lazy(() => import("./pages/EpisodeReader").then((mod) => ({ default: mod.EpisodeReader })));
...
export function App() {
  ...
  const nav = {
    ...
    toEpisode: (bookId: string, episodeNumber: number) =>
      setRoute({ page: "episode", bookId, episodeNumber }),
    ...
    toImport: (tab?: "episodes" | "canon") => setRoute({ page: "import", ...(tab ? { tab } : {}) }),
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-background/30 backdrop-blur-sm">
        ...
        <main className="flex-1 relative overflow-y-auto scroll-smooth">
          <Suspense fallback={<RouteLoading />}>
            ...
            {route.page === "episode" && (
              <div className="max-w-4xl mx-auto px-6 py-12 md:px-12 lg:py-16 fade-in">
                <EpisodeReader bookId={route.bookId} episodeNumber={route.episodeNumber} nav={nav} theme={theme} t={t} />
              </div>
            )}
