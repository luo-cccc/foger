  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <StatCard label={t("analytics.totalEpisodes")} value={data.totalEpisodes.toString()} c={c} />
        <StatCard label={t("analytics.totalDuration")} value={`${data.totalDurationSeconds.toLocaleString()}s`} c={c} />
        <StatCard label={t("analytics.avgDuration")} value={`${data.avgDurationSeconds.toLocaleString()}s`} c={c} />
      </div>
