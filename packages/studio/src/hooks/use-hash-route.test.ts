...
describe("hash route", () => {
  describe("parseHash", () => {
    ...
    it("parses a Doctor operation trace filter", () => {
      expect(parseHash("#/doctor?operationId=operation-123")).toEqual({
        page: "doctor",
    ...
    it("parses import tab routes", () => {
      expect(parseHash("#/import/canon")).toEqual({ page: "import", tab: "canon" });
    });
  ...
  describe("routeToHash", () => {
    ...
    it("import tab -> #/import/{tab}", () => {
      expect(routeToHash({ page: "import", tab: "episodes" })).toBe("#/import/episodes");
    });

    it("doctor operation trace -> URL hash", () => {
      expect(routeToHash({ page: "doctor", operationId: "operation-123" }))
        .toBe("#/doctor?operationId=operation-123");
    });
