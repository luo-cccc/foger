...
const strings = {
  ...
  "nav.createNovel": { zh: "漫剧创作", en: "Comic Drama" },
  "nav.createContinuation": { zh: "继续创作", en: "Continue Series" },
  ...
  "create.wordsPerEpisode": { zh: "每集时长（秒）", en: "Duration / Episode (seconds)" },
  "create.targetEpisodes": { zh: "目标集数", en: "Target Episodes" },
  ...
  "analytics.totalEpisodes": { zh: "总集数", en: "Total Episodes" },
  "analytics.totalDuration": { zh: "总时长", en: "Total Duration" },
  "analytics.avgDuration": { zh: "平均时长/集", en: "Avg Duration/Episode" },
  ...
  "bread.episode": { zh: "第{n}集", en: "Episode {n}" },
  ...
  "book.confirmDelete": { zh: "确认删除此漫剧及所有剧集？", en: "Delete this book and all episodes?" },
  ...
  "book.manuscriptTitle": { zh: "剧集标题", en: "Episode Title" },
  ...
  "import.episodes": { zh: "导入剧集", en: "Import Episodes" },
  ...
  "import.pasteEpisodes": { zh: "粘贴 EpisodeScript JSON 或分镜 Markdown...", en: "Paste EpisodeScript JSON or screenplay Markdown..." },
  ...
  "genre.episodeTypes": { zh: "剧集类型", en: "Episode Types" },
  ...
  "truth.noOverview": { zh: "还没有可汇总的运行时治理产物。开始规划或写作后，这里会出现剧集与篇章概览。", en: "No runtime governance artifacts to summarize yet. Episode and arc overview cards will appear after planning or writing starts." },
  "truth.openFile": { zh: "打开文件", en: "Open File" },
  "truth.runtimeArtifacts": { zh: "概览卡片", en: "Overview Cards" },
  "truth.latestEpisode": { zh: "最新剧集", en: "Latest Episode" },
  ...
  "truth.episodeGroup": { zh: "剧集治理", en: "Episode Governance" },
  ...
  "truth.episodeGroupHint": { zh: "查看最新剧集的写作意图、上下文组装、规则栈与治理追踪。", en: "Review the latest episode's intent, context assembly, rule stack, and governance trace together." },
  ...
  // Dashboard
  "dash.subtitle": { zh: "管理漫剧项目、剧集状态和 AI 辅助分镜稿。", en: "Manage comic-drama projects, episode state, and AI-assisted screenplays." },

  // Episode Reader extras
  ...
  "reader.endOfEpisode": { zh: "本集完", en: "End of Episode" },
  ...
  "episode.readyForReview": { zh: "待审核", en: "Ready for Review" },
  "episode.approved": { zh: "已通过", en: "Approved" },
  "episode.drafted": { zh: "草稿", en: "Drafted" },
  "episode.needsRevision": { zh: "需修订", en: "Needs Revision" },
  "episode.imported": { zh: "已导入", en: "Imported" },
  "episode.auditFailed": { zh: "审计失败", en: "Audit Failed" },
  "episode.stateDegraded": { zh: "状态降级", en: "State Degraded" },
  "episode.label": { zh: "第{n}集", en: "Episode {n}" },
