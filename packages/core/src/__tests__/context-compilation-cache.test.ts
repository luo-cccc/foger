...
describe("context compilation cache", () => {
  ...
  it("reuses stable context compilation while keeping episode context dynamic", async () => {
    ...
    const request = (episodeNumber: number): CompressibleContextCompileRequest => ({
      episodeNumber,
      ...
      compressibleEntries: [{
        ...
        excerpt: `Episode ${episodeNumber} title`,
      }],
    });
