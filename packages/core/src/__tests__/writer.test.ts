...
describe("WriterAgent", () => {
  ...
  it("replayEpisodeState consumes the persisted plan memo so hook ledger annotations are not lost", async () => {
    ...
    try {
      ...
      const memoBody = [
        "## 当前任务", "沈甲用虞允文玉佩叩开临州城门并建立立足点。",
        "## 本集爽点", "入场即被看见的身份跃迁。",
        "## 进入状态", "沈甲身处采石战场前夜，持有军情承诺与极低气运。",
        "## 当前目标", "在吕文安的怀疑与城防困局中站稳脚跟，并保住赤旗营的立足之地。",
        "## 反对力量", "吕文安的怀疑与城防器械短缺构成双重阻力。",
        "## 因果升级", "玉佩叩门换来姑且一试，突火枪验货换来三天限期。",
        "## 关系压力", "吕文安掌握绝对主动权，沈甲隐瞒知道城破的事实。",
        "## 方向性转折", "从凭本事换信任转向被列入重点观察名单。",
        "## 反转铺垫", "吕文安验过玉佩为真、验过判断为真，却下令彻查底细。",
        "## 本集反转", "专业表现让他从可用之人变成重点怀疑对象。",
        "## 反转后果", "三天限期成为倒计时，暗哨已布而沈甲不知。",
        "## 当集兑现", "入城、见吕文安、验证工械能力、拿到三天限期。",
        "## 出去压力", "三天内证明自己不是细作，否则王贵随时可以把他当细作处置。",
        "## 结尾交接状态", "沈甲成为被监视的可疑之人，暗哨已布而他一无所知。",
        "## 信息权限", "观众全知、沈甲不知自己被查、吕文安不知沈甲是穿越者。",
        "## 情绪钩子", "沈甲要如何在不知道自己被怀疑的情况下证明自己？",
        "## 结尾状态", "立足基础是怀疑而非信任。",
        "## 本集 Hook ledger",
        "advance:",
