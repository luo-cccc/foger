...
describe("governed-working-set", () => {
        ...
        selectedContext: [
          {
            ...
            reason: "Current episode opening hook.",
  ...
  it("filters character matrix by exact governed character mentions instead of broad capitalized tokens", () => {
    const matrix = [
      ...
      "",
      "### Encounter Log",
      "| Character A | Character B | First Meeting Episode | Latest Interaction Episode | Relationship Type | Relationship Change |",
      "| --- | --- | --- | --- | --- | --- |",
      "| Lin Yue | Guildmaster Ren | 1 | 5 | rivalry | strained |",
      "",
      "### Information Boundaries",
      "| Character | Known Information | Unknown Information | Source Episode |",
      "| --- | --- | --- | --- |",
