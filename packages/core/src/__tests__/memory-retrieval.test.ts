    ...
    await Promise.all([
      ...
      writeFile(
        ...
        [
          ...
          "| --- | --- | --- | --- | --- | --- | --- | --- |",
          "| 46 | 商会余波46 | 林己 | 林己处理商会杂务与路引试探 | 继续压住商会支线 | guild-route 试探 | 克制 | 过渡牵制 |",
          "| 47 | 商会余波47 | 林己 | 林己处理商会杂务与路引试探 | 继续压住商会支线 | guild-route 试探 | 克制 | 过渡牵制 |",
          "| 48 | 商会余波48 | 林己 | 林己处理商会杂务与路引试探 | 继续压住商会支线 | guild-route 试探 | 克制 | 过渡牵制 |",
          "| 49 | 商会余波49 | 林己 | 林己处理商会杂务与路引试探 | 继续压住商会支线 | guild-route 试探 | 克制 | 过渡牵制 |",
          "| 50 | 师债回响50 | 林己 | 林己再次追查师债线索，并核对誓令碎片痕迹 | 对师债真相的执念更强 | mentor-debt 推进 | 紧绷 | 主线推进 |",
          "",
        ].join("\n"),
        "utf-8",
      ),
...
describe("parsePendingHooksMarkdown", () => {
  ...
  it("drops prose rows whose hook id is not id-shaped", () => {
    ...
    const hooks = memoryRetrieval.parsePendingHooksMarkdown([
      "| hook_id | start_episode | type | status | last_advanced | expected_payoff | payoff_timing | depends_on | pays_off_in_arc | core_hook | half_life | promoted | notes |",
      "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |",
      "| H008 | 6 | 支线 | progressing | 7 | 第7集 | 近期 | [H003] | 第1篇第7集 | 否 | 10 | 是 | 周乙看到生命体征记录 |",
      "| 这条线索 | 6 | 支线 | deferred (受阻于 这条线索 (已阻 4 集)) | 0 | 第7集 | 近期 | [这条线索] | 第1篇第7集 | 否 | 10 | 是 | 周乙在装置内部看到生命体征监测记录 |",
