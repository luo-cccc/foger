...
describe("agent model routing catalog", () => {
  ...
  it("excludes retired settlement and creative agents from policy fallback", () => {
    expect(KNOWN_MODEL_ROUTING_AGENTS).not.toContain("settler");
    expect(KNOWN_MODEL_ROUTING_AGENTS).not.toContain("episode-analyzer");
