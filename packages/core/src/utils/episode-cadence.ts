...
export interface EpisodeCadenceAnalysis {
...
export const DEFAULT_EPISODE_CADENCE_WINDOW = CADENCE_WINDOW_DEFAULTS.summaryLookback;
...
export function analyzeEpisodeCadence(params: {
  readonly rows: ReadonlyArray<CadenceSummaryRow>;
  readonly language: "zh" | "en";
}): EpisodeCadenceAnalysis {
