...
export interface InteractionRuntimeTools {
  ...
  readonly reviseDraft: (bookId: string, chapterNumber: number, mode: InteractionReviseMode) => Promise<unknown>;
...
export async function runInteractionRequest(params: {
  ...
  switch (request.intent) {
    ...
    case "rewrite_chapter": {
      ...
      const mode: InteractionReviseMode = request.intent === "rewrite_chapter" ? "rewrite" : "spot-fix";
