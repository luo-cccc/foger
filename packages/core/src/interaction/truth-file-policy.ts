...
export const RUNTIME_DIAGNOSTIC_TRUTH_FILE_RE = /^runtime\/(?:(?:episode|episode)-\d{4}\.(?:intent\.md|plan\.md|context\.json|rule-stack\.yaml|trace\.json|claims\.json|claim-brief\.md)|recovery\.json|tier2_current_arc\.md|volume-contracts\.json|volume-progress\.json|volume-dashboard\.md|volume-\d{3}\.(?:contract\.json|dashboard\.md))$/;
