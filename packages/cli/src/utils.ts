...
import { createLLMClient, StateManager, createLogger, createStderrSink, createJsonLineSink, resolveEffectiveLLMConfig, loadLLMEnvLayers, resolveLLMTimeoutMs, GLOBAL_CONFIG_DIR, GLOBAL_ENV_PATH, type EffectiveLLMConfigResult, type LLMConfigCliOverrides, type ProjectConfig, type PipelineConfig, type LogSink } from "@actalk/inkos-core";
...
export function buildPipelineConfig(
  ...
  root: string,
  extra?: Partial<Pick<PipelineConfig, "notifyChannels" | "externalContext" | "inputGovernanceMode" | "episodeReviewMode" | "revisionGate">> & {
  ...
  return {
    ...
    episodeReviewMode: extra?.episodeReviewMode,
