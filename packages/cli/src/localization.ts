...
export function formatChapterRecoveryNotice(
  language: CliLanguage,
  recovery: ChapterRecovery | undefined,
): string | null {
  if (!recovery) {
    return null;
  }
  ...
  if (recovery.kind === "rolled-back") {
    return localize(language, {
      zh: `\u5df2\u6062\u590d\u672a\u5b8c\u6210\u7684\u7b2c ${recovery.chapterNumber} \u7ae0\u5199\u5165\uff0c\u5df2\u56de\u6eda\u81f3\u7b2c ${recovery.rolledBackTo} \u7ae0\u540e\u7ee7\u7eed\u3002`,
      en: `Recovered an incomplete chapter ${recovery.chapterNumber} write and rolled back to chapter ${recovery.rolledBackTo} before continuing.`,
    });
  }

  return localize(language, {
    zh: `\u5df2\u6e05\u7406\u7b2c ${recovery.chapterNumber} \u7ae0\u5df2\u63d0\u4ea4\u5199\u5165\u7559\u4e0b\u7684\u6062\u590d\u6807\u8bb0\u3002`,
    en: `Cleared the recovery marker left by the committed chapter ${recovery.chapterNumber} write.`,
  });
}
