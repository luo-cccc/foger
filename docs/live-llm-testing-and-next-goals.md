...
截至 2026-07-16，项目本地逻辑、持久化、确定性测试和前后端联动合同已经较稳；最新真实证据已经从单章/三章推进到连续 15 个已提交章节：
...
- 当前下一步不是回退到 3-5 章或继续压低写作成本，而是在全新隔离项目重跑 20 章，要求 20/20 持久化、truth/快照一致、Doctor 全部关联，并让报告可靠写出终态。
