...
本文档目录按“当前基线、能力计划、专项设计、测试记录”分层，避免路线图、设计规范和按日期追加的实验日志互相覆盖。
...
- [写作能力提升开发方案](writing-capability-improvement-plan.md)：把成书规划、单章正文、连续性、修订、文风和长篇自主性的缺陷转成评价合同、开发工作流、人工盲评和两次 20 章验收标准。
