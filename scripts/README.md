...
- `live-dual-api-routing.mjs`: optional provider-routing probe. It records service/model usage, retries, token totals, episode duration drift, review telemetry, and governance call counts without writing keys to the repository.
